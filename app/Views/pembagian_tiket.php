         ...
         <div class="card card-filter m-1 text-center">
            <div class="row">
               <div class="col-md-9">
                  <div class="row">
                     <div class="col-md-3">
                        <select class="form-select text-center form-select-sm input-filter" id="f_teknisi" aria-label=".form-select-sm example">
                     ...
                     <div class="col-md-3">
                        <input type="date" class="form-control form-control-sm text-center input-filter" id="f_tgl" value="<?= date('Y-m-d'); ?>">
                     </div>
                     <div class="col-md-3">
